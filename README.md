# M2 Proto Unpacker
M2 Proto Unpacker is a standalone tool that loads binary **item_proto** and **mob_proto** files, optionally decrypts them using **[TEA]** (*Tiny Encryption Algorithm*), decompresses them with the **[Snappy]** codec, parses their internal structures, and exports the decoded data into `.txt` tables.
