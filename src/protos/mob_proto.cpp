...
std::string MobTable::get_rank_string() const
{
...
std::string MobTable::get_type_string() const
{
...
std::string MobTable::get_battle_type_string() const
{
...
std::string MobTable::get_immune_flags_string() const
{
